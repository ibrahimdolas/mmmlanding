...
const About = () => {
	return (
		<Layout title="About">
			...
			<ParallaxPageTitle
				image={aboutPageData.parallaxBg}
				title={aboutPageData.pageTitle}
				crumbs={aboutPageData.crumbs}
			/>
			
			<section className="vs-about--section pt-30 space space-extra-bottom z-index-common overflow-hidden background-image" style={{backgroundImage: `url(${aboutPageData.bg})`}}>
				
				<img src={aboutPageData.palm} alt="Palm" className="vs-about--ele1"/>
				<img src={aboutPageData.lines} alt="Lines" className="vs-about--ele1h3"/>
					...
					<div className="row align-items-center pt-30 gx-50">
						<div className="col-lg-6 mb-30 wow" data-animate="fadeInUp" data-wow-delay="0.25s">
							<div className="vs-about--image style2">
								<img src={aboutPageData.collage} alt="About The Project"/>
							</div>
						</div>
						<div className="col-lg-6 mb-30 wow" data-animate="fadeInUp" data-wow-delay="0.25s">
							<AboutTabs/>
