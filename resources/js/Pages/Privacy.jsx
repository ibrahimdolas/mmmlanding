...
const paragraphs = [
	...
	},
	{
		...
		`,
		ro: `
		Prelucrarea datelor cu caracter personal se realizează în conformitate cu Legea nr. 6698 privind Protecția Datelor cu Caracter Personal (KVKK) și cu Regulamentul General al Uniunii Europene privind Protecția Datelor (GDPR), de către coordonatorul de proiect Universitatea din Adıyaman (Operator de date) și partenerii de proiect (<strong>Grădinița cu Program Prelungit „Căsuța Bucuriei” nr.1. Brașov, Scuola Paritaria Dell’infanzia e Primaria „Missionarie Catechiste Del Sacro Cuore” Portici</strong>).
		`
	},
	{
		title: true,
	...
	},
	{
		...
		ro: 'Următoarele tipuri de date pot fi colectate atunci când utilizați Portalul:'
	},
	{
		list: true,
		items: [
			...
			},
			{
				...
				ro: 'Date profesionale: Instituție, poziția, experiență în predare.'
			},
			{
				...
				ro: 'Date de utilizare: Adresă IP, tip de browser, sistem de operare, durata vizitei și paginile accesate (prin cookie-uri).'
			},
			{
	...
	},
	{
		...
		ro: 'Datele colectate sunt folosite pentru:'
	},
	{
		list: true,
		items: [
			{
				...
				ro: 'Permiterea utilizării Portalului și gestionarea contului dumneavoastră,'
			},
			{
	...
	},
	{
		...
		ro: 'Datele pot fi transferate exclusiv partenerilor din consorțiul menționat la articolul 1 (România, Italia și Turcia) pentru remedierea deficiențelor, corectarea erorilor, efectuarea analizelor și atingerea obiectivelor proiectului.'
	},
	{
		title: true,
		...
		ro: '3. Metode de colectare și temei legal'
	},
	{
		...
		ro: 'Datele personale sunt colectate prin mijloace automate sau non-automate, oral, scris sau electronic. Prelucrarea datelor se realizează conform: KVKK (Legea nr. 6698 privind Protecția Datelor cu Caracter Personal) – art. 5 și art. 6/3, GDPR – art. 6. Temeiurile legale pentru prelucrare includ:'
	},
	{
		list: true,
		items: [
	...
	},
	{
		...
		ro: 'Se aplică măsuri tehnice (de exemplu, criptare) și administrative pentru prevenirea accesului neautorizat, pierderii sau divulgării datelor dumneavoastră personale.'
	},
	{
		title: true,
	...
	},
	{
		...
		ro: 'Datele personale vor fi păstrate pe durata proiectului (24 luni) și ulterior atât timp cât este necesar pentru respectarea obligațiilor legale. După această perioadă, datele vor fi anonimizate sau distruse.'
	},
	{
		title: true,
		tr: '6. Haklarınız',
	...
	},
	{
		...
		ro: 'Conform KVKK și GDPR, aveți următoarele drepturi:'
	},
	{
		list: true,
		items: [
			{
				...
				ro: 'a) Să aflați dacă datele dumneavoastră sunt prelucrate,'
			},
			{
				...
				ro: 'b) Să solicitați informații despre prelucrarea datelor personale,'
			},
			{
				...
				ro: 'c) Să cunoașteți scopul prelucrării și conformitatea acesteia,'
			},
			{
				...
				ro: 'd) Să identificați terții cărora li s-au transferat datele,'
			},
			{
				...
				ro: 'e) Să solicitați corectarea datelor incomplete sau inexacte,'
			},
			{
				...
				ro: 'f) Să cereți ștergerea sau distrugerea datelor personale (conform art. 7 KVKK),'
			},
			{
				...
				ro: 'g) Să solicitați notificarea terților despre corectări sau ștergeri,'
			},
			{
				...
				ro: 'h) Să vă opuneți deciziilor automate care vă afectează în mod direct,'
			},
			{
				...
				ro: 'i) Să solicitați despăgubiri pentru prejudicii cauzate de prelucrarea ilegală a datelor.'
			},
		]
	},
	{
	...
	},
	{
		...
		ro: `
		Pentru exercitarea drepturilor sau întrebări privind datele personale:<br/>E-mail: <a href="mailto:mathmagicinmotion@gmail.com" target="_blank">mathmagicinmotion@gmail.com</a><br/>Toate solicitările trebuie adresate direct Universității din Adıyaman.<br/>Aveți dreptul să depuneți plângeri la Autoritatea pentru Protecția Datelor cu Caracter Personal din Turcia (KVKK) sau la autoritatea relevantă din țara dumneavoastră.
		`
	}
]
